		...
		return (
			<div className="App">
				...
				<div className="stories">
					<Stories loop keyboardNavigation defaultInterval={2000} stories={stories2}
...
const MVP = ({action, isPaused}) => {

	return <div style={{...contentStyle, background: 'pink', color: '#16161d'}}>
		<h1>Best Wine on the market</h1>
		{/*<p>Render your custom JSX by passing just a <code style={{fontStyle: 'italic'}}>content</code> property inside*/}
		{/*	your story object.</p>*/}
		{/*<p>You get a <code style={{fontStyle: 'italic'}}>action</code> prop as an input to your content function, that*/}
		{/*	can be used to play or pause the story.</p>*/}
		{/*<h1>{isPaused ? 'Paused' : 'Playing'}</h1>*/}
		{/*<h4>v2 is out 🎉</h4>*/}
		{/*<p>React Native version coming soon.</p>*/}

		<a href="https://www.vineshop24.de/weine-aus-aller-welt/italien/sizilien/donnafugata-sedara-doc-sicilia-rosso.html?wgu=10475_16644_16148013124285_0297e9a4c9&wgexpiry=1622577312&utm_source=Affiliate&utm_medium=webgains&utm_campaign=16644&source=webgains&siteid=16644">
			<img src="https://i.ya-webdesign.com/images/wine-png-4.png" width="100" height="100"/>
		</a>
		<a href="https://www.vineshop24.de/weine-aus-aller-welt/italien/sizilien/donnafugata-sedara-doc-sicilia-rosso.html?wgu=10475_16644_16148013124285_0297e9a4c9&wgexpiry=1622577312&utm_source=Affiliate&utm_medium=webgains&utm_campaign=16644&source=webgains&siteid=16644">
			<img src="https://i.ya-webdesign.com/images/wine-png-4.png" width="100" height="100"/>
		</a>
...
const stories2 = [
	...
	// 			<br/>
	// 			<img style={image}
	// 				 src="https://images.unsplash.com/photo-1565506737357-af89222625ad?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80"></img>
	...
	// },
	{
		...
		seeMoreCollapsed: ({toggleMore, action}) => <p style={customSeeMore} onClick={() => toggleMore(true)}>A custom
			See More message →</p>,
		seeMore: ({close}) => <div style={{maxWidth: '100%', height: '100%', padding: 40, background: 'white'}}><h2>Just
			checking the see more feature.</h2><p style={{textDecoration: 'underline'}} onClick={close}>Go on, close
			this popup.</p></div>,
		duration: 2000
	},
	{
